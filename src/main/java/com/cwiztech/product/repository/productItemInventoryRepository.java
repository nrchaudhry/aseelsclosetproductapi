...
public interface productItemInventoryRepository extends JpaRepository<ProductItemInventory, Long>{
	...
	@Query(value = "select * from TBLPRODUCTITEMINVENTORY "
            ...
            + "and CASE WHEN :INVENTORYCLASSIFICTION_ID = 0 THEN INVENTORYCLASSIFICTION_ID=INVENTORYCLASSIFICTION_ID ELSE INVENTORYCLASSIFICTION_ID IN (:INVENTORYCLASSIFICTION_IDS) END "
