...
public class Product {
    ...
    @Column(name = "SALELEDGERACCOUNT_ID")
    private Long SALELEDGERACCOUNT_ID;
    
	@Transient
	private String SALELEDGERACCOUNT_DETAIL;
	
    @Column(name = "PURCHASELEDGERACCOUNT_ID")
    private Long PURCHASELEDGERACCOUNT_ID;
	...
	public Long getSALELEDGERACCOUNT_ID() {
		return SALELEDGERACCOUNT_ID;
	}

	public void setSALELEDGERACCOUNT_ID(Long sALELEDGERACCOUNT_ID) {
		SALELEDGERACCOUNT_ID = sALELEDGERACCOUNT_ID;
	}

	public String getSALELEDGERACCOUNT_DETAIL() {
		return SALELEDGERACCOUNT_DETAIL;
	}

	public void setSALELEDGERACCOUNT_DETAIL(String sALELEDGERACCOUNT_DETAIL) {
		SALELEDGERACCOUNT_DETAIL = sALELEDGERACCOUNT_DETAIL;
	}

	public Long getPURCHASELEDGERACCOUNT_ID() {
		return PURCHASELEDGERACCOUNT_ID;
	}

	public void setPURCHASELEDGERACCOUNT_ID(Long pURCHASELEDGERACCOUNT_ID) {
		PURCHASELEDGERACCOUNT_ID = pURCHASELEDGERACCOUNT_ID;
	}

	public String getPURCHASELEDGERACCOUNT_DETAIL() {
		return PURCHASELEDGERACCOUNT_DETAIL;
	}

	public void setPURCHASELEDGERACCOUNT_DETAIL(String pURCHASELEDGERACCOUNT_DETAIL) {
