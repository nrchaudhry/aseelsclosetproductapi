...
public class productItemAttributeValueController {
	...
	public ResponseEntity get(@RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productitemattributevalue", null, null, headToken);
		...
		return new ResponseEntity(getAPIResponse(productitemattributevalues, null , null, null, null, apiRequest, true), HttpStatus.OK);
	}
	...
	public ResponseEntity getAll(@RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productitemattributevalue/all", null, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity getOne(@PathVariable Long id, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productitemattributevalue/"+id, null, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);

		ProductItemAttributeValue productitemattributevalue = productitemattributevaluerepository.findOne(id);
		
		return new ResponseEntity(getAPIResponse(null, productitemattributevalue , null, null, null, apiRequest, true), HttpStatus.OK);
	}
	...
	public ResponseEntity getByIDs(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
		...
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productitemattributevalue/ids", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity getByProductItemIDs(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productitemattributevalue/productitem/ids", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity getByNotInIDs(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productitemattributevalue/notin/ids", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity insert(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productitemattributevalue", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity update(@PathVariable Long id, @RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
		...
		JSONObject apiRequest = AccessToken.checkToken("PUT", "/productitemattributevalue/"+id, data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
		JSONObject jsonObj = new JSONObject(data);
		jsonObj.put("id", id);
	...
	public ResponseEntity insertupdate(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("PUT", "/productitemattributevalue", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public ResponseEntity insertupdateAll(JSONArray jsonProductItemAttributeValues, JSONObject jsonProductItemAttributeValue, JSONObject apiRequest) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		...
		for (int a=0; a<jsonProductItemAttributeValues.length(); a++) {
			...
			if (jsonObj.has("productitemattributevalue_ID")) {
				...
				if (productitemattributevalueid != 0) {
					...
					if (productitemattributevalue == null)
						return new ResponseEntity(getAPIResponse(null, null , null, null, "Invalid ProductItemAttributeValue Data!", apiRequest, true), HttpStatus.OK);
				}
			}
			...
			productitemattributevalue.setMODIFIED_BY(apiRequest.getLong("request_ID"));
			productitemattributevalue.setMODIFIED_WORKSTATION(apiRequest.getString("log_WORKSTATION"));
		...
		if (jsonProductItemAttributeValue != null)
			responseentity = new ResponseEntity(getAPIResponse(null, productitemattributevalues.get(0) , null, null, null, apiRequest, true), HttpStatus.OK);
		else
			responseentity = new ResponseEntity(getAPIResponse(productitemattributevalues, null , null, null, null, apiRequest, true), HttpStatus.OK);
	...
	public ResponseEntity BySearch(String data, boolean active, String headToken, String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productitemattributevalue/search" + ((active == true) ? "" : "/all"), data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity ByAdvancedSearch(String data, boolean active, String headToken, String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productitemattributevalue/advancedsearch" + ((active == true) ? "" : "/all"), data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
		...
		JSONObject jsonObj = new JSONObject(data);
		 ...
		 JSONArray searchObject = new JSONArray();
	        ...
	        productattributevalue_IDS.add((int) 0);
	        
			long productitem_ID = 0,productattribute_ID = 0,productattributevalue_ID = 0;
     ...
     if (jsonObj.has("productattributevalue_ID") && !jsonObj.isNull("productattributevalue_ID") && jsonObj.getLong("productattributevalue_ID") != 0) {
         productattributevalue_ID = jsonObj.getLong("productattributevalue_ID");
         productattributevalue_IDS.add((int) productattributevalue_ID);
     } else if (jsonObj.has("productattributevalue") && !jsonObj.isNull("productattributevalue") && jsonObj.getLong("productattributevalue") != 0) {
         if (active == true) {
             searchObject = new JSONArray(ServiceCall.POST("productattributevalue/advancedsearch", jsonObj.toString().replace("\"", "'"), headToken, false));
         } else {
             searchObject = new JSONArray(ServiceCall.POST("productattributevalue/advancedsearch/all", jsonObj.toString().replace("\"", "'"), headToken, false));
         }

         productattributevalue_ID = searchObject.length();
         for (int i=0; i<searchObject.length(); i++) {
             productattributevalue_IDS.add((int) searchObject.getJSONObject(i).getLong("productattributevalue_ID"));
         }
     }	
		
		List<ProductItemAttributeValue> productitemattributevalues = ((active == true)
				? productitemattributevaluerepository.findByAdvancedSearch(productitem_ID,productitem_IDS, productattribute_ID,productattribute_IDS,productattributevalue_ID,productattributevalue_IDS)
				: productitemattributevaluerepository.findAllByAdvancedSearch(productitem_ID,productitem_IDS, productattribute_ID,productattribute_IDS,productattributevalue_ID,productattributevalue_IDS));	
...
//						else
//						    jsonproductitemattributevalue = new JSONObject(ServiceCall.GET("productitemattributevalue/"+productitemattributevalue.get(j).getPRODUCTATTRIBUTEVALUE_ID(), apiRequest.getREQUEST_OUTPUT()));
	...
	String getAPIResponse(List<ProductItemAttributeValue> productitemattributevalues, ProductItemAttributeValue productitemattributevalue , JSONArray jsonProductItemAttributeValues, JSONObject jsonProductItemAttributeValue, String message, JSONObject apiRequest, boolean isWithDetail) throws JSONException, JsonProcessingException, ParseException, InterruptedException, ExecutionException {
		...
		if (message != null) {
			...
			if ((productitemattributevalues != null || productitemattributevalue != null) && isWithDetail == true) {
				...
				rtnAPIResponse = jsonProductItemAttributeValue.toString();
				apiRequestLog.apiRequestSaveLog(apiRequest, rtnAPIResponse, "Success");
			}
		}
