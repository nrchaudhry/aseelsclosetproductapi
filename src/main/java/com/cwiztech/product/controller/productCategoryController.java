...
public class productCategoryController {
	...
	public ResponseEntity get(@RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productcategory", null, null, headToken);
		...
		return new ResponseEntity(getAPIResponse(productcategories, null , null, null, null, apiRequest, true), HttpStatus.OK);
	}
	...
	public ResponseEntity getAll(@RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productcategory/all", null, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity getOne(@PathVariable Long id, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productcategory/"+id, null, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);

		ProductCategory productcategory = productcategoryrepository.findOne(id);

		return new ResponseEntity(getAPIResponse(null, productcategory , null, null, null, apiRequest, true), HttpStatus.OK);
	}
	...
	public ResponseEntity getByIDs(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
		...
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productcategory/ids", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity getByNotInIDs(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productcategory/notin/ids", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity insert(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productcategory", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity update(@PathVariable Long id, @RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
		...
		JSONObject apiRequest = AccessToken.checkToken("PUT", "/productcategory/"+id, data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
		JSONObject jsonObj = new JSONObject(data);
		jsonObj.put("id", id);
	...
	public ResponseEntity insertupdate(@RequestBody String data, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant)
			throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("PUT", "/productcategory", data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public ResponseEntity insertupdateAll(JSONArray jsonProductcategories, JSONObject jsonProductCategory, JSONObject apiRequest) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		...
		for (int a=0; a<jsonProductcategories.length(); a++) {
			...
			if (jsonObj.has("productcategory_ID")) {
				...
				if (productcategoryid != 0) {
					...
					if (productcategory == null)
						return new ResponseEntity(getAPIResponse(null, null , null, null, "Invalid ProductCategory Data!", apiRequest, true), HttpStatus.OK);
				}
			}

			if (productcategoryid == 0) {
				if (!jsonObj.has("productcategory_NAME") || jsonObj.isNull("productcategory_NAME"))
					return new ResponseEntity(getAPIResponse(null, null , null, null, "productcategory_NAME is missing", apiRequest, true), HttpStatus.OK);

				if (!jsonObj.has("productcategoryorder_NO") || jsonObj.isNull("productcategoryorder_NO"))
					return new ResponseEntity(getAPIResponse(null, null , null, null, "productcategoryorder_NO is missing", apiRequest, true), HttpStatus.OK);
			}
			...
			if (jsonObj.has("productcategoryimage_URL") && !jsonObj.isNull("productcategoryimage_URL"))
				productcategory.setPRODUCTCATEGORYIMAGE_URL(jsonObj.getString("productcategoryimage_URL"));
			...
			productcategory.setMODIFIED_BY(apiRequest.getLong("request_ID"));
			productcategory.setMODIFIED_WORKSTATION(apiRequest.getString("log_WORKSTATION"));
		...
		if (jsonProductCategory != null)
			responseentity = new ResponseEntity(getAPIResponse(null, productcategories.get(0) , null, null, null, apiRequest, true), HttpStatus.OK);
		else
			responseentity = new ResponseEntity(getAPIResponse(productcategories, null , null, null, null, apiRequest, true), HttpStatus.OK);
	...
	public ResponseEntity BySearch(String data, boolean active, String headToken, String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productcategory/search" + ((active == true) ? "" : "/all"), data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
	...
	public ResponseEntity ByAdvancedSearch(String data, boolean active, String headToken, String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("POST", "/productcategory/advancedsearch" + ((active == true) ? "" : "/all"), data, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
		...
		return new ResponseEntity(getAPIResponse(productcategories, null , null, null, null, apiRequest, isWithDetail), HttpStatus.OK);
	}

	String getAPIResponse(List<ProductCategory> productcategories, ProductCategory productcategory , JSONArray jsonProductcategories, JSONObject jsonProductCategory, String message, JSONObject apiRequest, boolean isWithDetail) throws JSONException, JsonProcessingException, ParseException, InterruptedException, ExecutionException {
		ObjectMapper mapper = new ObjectMapper();
		String rtnAPIResponse="Invalid Resonse";
		long productcategoryID = 0;

		if (message != null) {
			rtnAPIResponse = apiRequestLog.apiRequestErrorLog(apiRequest, "ProductCategory", message).toString();
		} else {
			if (productcategory != null && isWithDetail == true) {
				rtnAPIResponse = mapper.writeValueAsString(productcategory);
				apiRequestLog.apiRequestSaveLog(apiRequest, rtnAPIResponse, "Success");

			} else if (productcategories != null && isWithDetail == true) {
				rtnAPIResponse = mapper.writeValueAsString(productcategories);
				apiRequestLog.apiRequestSaveLog(apiRequest, rtnAPIResponse, "Success");
				...
				rtnAPIResponse = jsonProductcategories.toString();
				apiRequestLog.apiRequestSaveLog(apiRequest, rtnAPIResponse, "Success");

			} else if (jsonProductCategory  != null) {
				rtnAPIResponse = jsonProductCategory.toString();
				apiRequestLog.apiRequestSaveLog(apiRequest, rtnAPIResponse, "Success");
			}
		}
	...
	public String getActiveWeb(@RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
	...
	public ResponseEntity getOneWeb(@PathVariable Long id, @RequestHeader(value = "Authorization") String headToken, @RequestHeader(value = "LimitGrant") String LimitGrant) throws JsonProcessingException, JSONException, ParseException, InterruptedException, ExecutionException {
		JSONObject apiRequest = AccessToken.checkToken("GET", "/productcategory/"+id, null, null, headToken);
		if (apiRequest.has("error")) return new ResponseEntity(apiRequest.toString(), HttpStatus.OK);
		...
		return new ResponseEntity(getAPIResponse(null, null, null, objproductcategory, null, apiRequest, true), HttpStatus.OK);
	}
